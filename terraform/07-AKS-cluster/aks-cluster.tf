...
resource "azurerm_role_assignment" "appdevs_user" {
  ...
  principal_id         = "12fb4ad1-d7c4-43d5-a723-b5310c36973f" # data.terraform_remote_state.aad.outputs.appdev_object_id
}

resource "azurerm_role_assignment" "aksops_admin" {
  scope                = module.aks.aks_id
  role_definition_name = "Azure Kubernetes Service RBAC Cluster Admin"
  principal_id         = "7646ec99-587a-4cc6-bf56-40f360971eb1" # data.terraform_remote_state.aad.outputs.aksops_object_id
}
